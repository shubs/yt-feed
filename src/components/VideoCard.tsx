...
const VideoCard = ({ title, views, thumbnail, channelName, publishedAt, videoUrl, channelUrl }: VideoCardProps) => {
  ...
  return (
    ...
    >
      <ShineBorder 
        className="w-full p-0 min-w-0 bg-transparent"
        borderRadius={12}
        color={["#FE8FB5", "#FFBE7B", "#A07CFE"]}
        duration={8}
      >
        <Card className="overflow-hidden border-none shadow-none hover:bg-secondary/50 transition-colors duration-200 rounded-xl">
